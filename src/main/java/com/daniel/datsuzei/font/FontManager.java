...
public class FontManager extends Manager<ClientFontRenderer> {
    ...
    public void preMinecraftLaunch() {
        ...
        fontDirectory = new File(DatsuzeiClient.getSingleton().getDirectory(), "Fonts");
        ...
        if(!fontDirectory.exists()) {
            ...
            try {
                ...
                File downloadedFile = FileUtil.downloadFile("https://github.com/jezevcik/datsuzei-cloud/raw/main/Fonts.zip", new File(fontDirectory, "Fonts.zip").getCanonicalPath());
